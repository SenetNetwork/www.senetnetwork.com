<template>
  <section ref="panel" class="section">
    ...
    <div ref="canvas" class="topic-canvas">
      ...
      <img ref="imgPlay" class="img-play" src="@/assets/images/community-play.svg" />
      <img ref="imgEarn" class="img-earn" src="@/assets/images/community-earn.svg" />
      <img ref="imgAngle" class="img-angle" src="@/assets/images/community-angle.svg" />
      <img ref="imgArrow" class="img-arrow" src="@/assets/images/community-arrow.svg" />
      <img ref="imgStick" class="img-stick" src="@/assets/images/community-stick.svg" />
      <img ref="imgBlock" class="img-block" src="@/assets/images/community-block.svg" />
    </div>
    <div ref="contactWrap" class="contact-wrap">
      <ul class="contact-us">
        <li>
          <a ref="contact1" href="https://discord.gg/qh9dG9EwQx" target="_blank">
            <img class="icon icon-discord" src="@/assets/images/icon-discord.svg" />
            <span class="text">/Discord</span>
            <img class="icon-arrow" src="@/assets/images/icon-arrow.svg" />
          </a>
        </li>
        <li>
          <a ref="contact2" href="https://twitter.com/SenetNetwork" target="_blank">
            <img class="icon icon-twitter" src="@/assets/images/icon-twitter.svg" />
      ...
      <ul class="contact-us">
        <li>
          <a ref="contact3" href="https://medium.com/@SenetNetwork" target="_blank">
            <img class="icon icon-medium" src="@/assets/images/icon-medium.svg" />
